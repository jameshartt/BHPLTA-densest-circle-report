...
**3.94 courts per km² of land**, ahead of Chicago, Melbourne, Greater
London, Paris, Auckland, New York, Brussels, Sydney, San Francisco
and every other audited city. Brighton is the only city in the global
top eight with a population under one million.
...
data/processed/  Final CSVs (densest-circle counts, per-city audits)
...
- **Tokyo is asterisked** in the ranking because the global pipeline
  ...
  recount, Tokyo's density falls to roughly 3.0-3.6.
...
[jim.tennis](https://github.com/) — May 2026.
